...
--
-- Name: debit; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE IF NOT EXISTS public.saddaa(
    userid integer,
...
--ALTER TABLE public.debit OWNER TO admin;
...
--
-- Name: holder; Type: TABLE; Schema: public; Owner: admin
--
...
--ALTER TABLE public.holder OWNER TO admin;

--
-- Name: holder_userid_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

--CREATE SEQUENCE public.holder_userid_seq
--    AS integer
 --   START WITH 1
 --   INCREMENT BY 1
  --  NO MINVALUE
...
--ALTER SEQUENCE public.holder_userid_seq OWNER TO admin;

--
-- Name: holder_userid_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: admin
--

--ALTER SEQUENCE public.holder_userid_seq OWNED BY public.holder.userid;


--
-- Name: transactionlist; Type: TABLE; Schema: public; Owner: admin
--
...
--ALTER TABLE public.transactionlist OWNER TO admin;

--
-- Name: holder userid; Type: DEFAULT; Schema: public; Owner: admin
--

--ALTER TABLE ONLY public.holder ALTER COLUMN userid SET DEFAULT nextval('public.holder_userid_seq'::regclass);


--
-- Data for Name: debit; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public.debit (userid, accid, accounttype, accstats, balance, acccreationdate) FROM stdin;
...
COPY public.deposit (userid, accid, accounttype, accstats, balance, acccreationdate) FROM stdin;
...
--
-- Data for Name: holder; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public.holder (userid, fullname, surname, email, phone, pass, gender, authstats, userbirthdate, user_creation_date, authip, token_creation_date, auth_token) FROM stdin;
...
4	ismail	turker	tamerturkerceza@hotmail.com	05321252145	123123	male	\N	1994-01-01	2024-05-08 17:33:14.717684	\N	\N	\N
...
--
-- Data for Name: transactionlist; Type: TABLE DATA; Schema: public; Owner: admin
--
/*
COPY public.transactionlist (transactionid, accid, amount, shortdes, transactiondate) FROM stdin;
...
--
-- Name: holder_userid_seq; Type: SEQUENCE SET; Schema: public; Owner: admin
--

--SELECT pg_catalog.setval('public.holder_userid_seq', 4, true);
...
--
-- Name: debit deposit_pkey_1; Type: CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: holder holder_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: transactionlist transactionlist_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--
/*
